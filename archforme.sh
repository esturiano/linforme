...
while true; do
    ...
    case $yn in
        [Yy]* )
            ...
            yay -S --noconfirm reflector-simple gnome-disk-utility okular imagewriter gimp kdenlive obs-studio blender soundkonverter libreoffice-fresh libreoffice-fresh-ru
            echo -en '\033[32;1mDone.\033[0m\n'
